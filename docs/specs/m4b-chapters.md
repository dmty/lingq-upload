...
3. **No re-ordering, no merging.** Atoms come out of the parser in file order; that order is the contract. Adjacent atoms with the same title are not merged (they may represent intentional sub-sections).
