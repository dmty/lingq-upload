...
fn leak2(s: &str) -> &'static str {
    match s {
        "aa" => "aa", "ab" => "ab", "af" => "af", "ak" => "ak",
        "ar" => "ar", "as" => "as", "az" => "az", "be" => "be",
        "bg" => "bg", "bn" => "bn", "bo" => "bo", "bs" => "bs",
        "ca" => "ca", "cs" => "cs", "cy" => "cy", "da" => "da",
        "el" => "el", "et" => "et", "fa" => "fa", "fi" => "fi",
        "ga" => "ga", "gl" => "gl", "gu" => "gu", "he" => "he",
        "hi" => "hi", "hr" => "hr", "hu" => "hu", "hy" => "hy",
        "id" => "id", "is" => "is", "ka" => "ka", "kk" => "kk",
        "km" => "km", "kn" => "kn", "ky" => "ky", "la" => "la",
        "lo" => "lo", "lt" => "lt", "lv" => "lv", "mk" => "mk",
        "ml" => "ml", "mn" => "mn", "mr" => "mr", "ms" => "ms",
        "my" => "my", "ne" => "ne", "nl" => "nl", "no" => "no",
        "pa" => "pa", "pl" => "pl", "ro" => "ro", "si" => "si",
        "sk" => "sk", "sl" => "sl", "so" => "so", "sq" => "sq",
        "sr" => "sr", "sv" => "sv", "sw" => "sw", "ta" => "ta",
        "te" => "te", "th" => "th", "tl" => "tl", "tr" => "tr",
