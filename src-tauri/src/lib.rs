...
pub fn specta_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::transcribe::cmd_confirm_detected_range,
            commands::transcribe::cmd_reset_detection,
            ...
            commands::project::cmd_project_plan_preview,
            commands::project::cmd_set_selection,
            commands::project::cmd_set_absorb_policy,
            commands::project::cmd_set_cover,
            commands::project::cmd_set_cover_bytes,
            commands::project::cmd_set_cover_use,
...
pub fn run() {
    ...
    tauri::Builder::default()
        .register_uri_scheme_protocol("audio", audio_scheme::handler)
